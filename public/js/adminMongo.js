...
function paginate(){
    ...
    .done(function(response){
        ...
        if(query_string == null){
            ...
            isFiltered = " <span class='text-danger'>(过滤后)</span>";
        }
        ...
        for(var i = 0; i < response.data.length; i++){
            ...
            var inner_html = '<div class="col-xs-12 col-md-12 col-lg-12 no-side-pad"><pre class="code-block ' + docClass + '"><i class="fa fa-chevron-down code-block_expand"></i><code class="json">' + escaper[0].innerHTML + '</code></pre></div>';
